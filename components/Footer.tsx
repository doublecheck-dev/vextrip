        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-300">Our Tours</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-300">Restaurants</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-300">Hotels</a></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-300">Food Tours</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-300">Private Dining</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-300">Catering</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-300">Events</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-300">Reservations</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300 text-sm">123 Food Street, Culinary District</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-orange-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="flex space-x-4">
                <a href="#" className="group p-3 rounded-full bg-gray-800 hover:bg-orange-500 transition-all duration-300 transform hover:scale-110">
                  <svg className="w-8 h-8 text-gray-300 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
