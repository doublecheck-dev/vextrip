...
import { Star, MapPin, Phone, Clock, ArrowLeft, Calendar, Users, Mail, ExternalLink, Utensils, CreditCard, ChefHat } from "lucide-react";
import { restaurants } from "@/lib/restaurants-data";
import WhatsAppQR from "@/components/WhatsAppQR";

const getAmenityIcon = (amenity: string) => {
  switch (amenity.toLowerCase()) {
    case 'wifi': return <Utensils className="w-4 h-4" />;
    case 'estacionamiento': return <CreditCard className="w-4 h-4" />;
    case 'terraza': return <ChefHat className="w-4 h-4" />;
